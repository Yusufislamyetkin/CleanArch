...
/// </summary>
public class DepositMoneyCommandHandler : ICommandHandler<DepositMoneyCommand, DepositResult>
{
    private readonly IAccountRepository _accountRepository;
    private readonly IUnitOfWork _unitOfWork;
...
/// </summary>
public class WithdrawMoneyCommandHandler : ICommandHandler<WithdrawMoneyCommand, WithdrawResult>
{
    private readonly IAccountRepository _accountRepository;
    private readonly IUnitOfWork _unitOfWork;
    ...
    public async Task<WithdrawResult> Handle(WithdrawMoneyCommand request, CancellationToken cancellationToken)
    {
        // Get account
        var account = await _accountRepository.GetByIdAsync(request.AccountId, cancellationToken);
        if (account == null)
...
/// </summary>
public class TransferMoneyCommandHandler : ICommandHandler<TransferMoneyCommand, TransferResult>
{
    private readonly IAccountDomainService _accountDomainService;
    private readonly IAccountRepository _accountRepository;
    private readonly IUnitOfWork _unitOfWork;
...
/// </summary>
public class UpdateAccountNameCommandHandler : ICommandHandler<UpdateAccountNameCommand, Unit>
{
    private readonly IAccountRepository _accountRepository;
    private readonly IUnitOfWork _unitOfWork;
    ...
    public async Task<Unit> Handle(UpdateAccountNameCommand request, CancellationToken cancellationToken)
    {
        // Get account
        var account = await _accountRepository.GetByIdAsync(request.AccountId, cancellationToken);
        if (account == null)
...
/// </summary>
public class CloseAccountCommandHandler : ICommandHandler<CloseAccountCommand, Unit>
{
    private readonly IAccountRepository _accountRepository;
    private readonly IUnitOfWork _unitOfWork;
