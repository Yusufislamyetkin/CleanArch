...
public class AccountNumberGeneratorDomainService : IAccountNumberGeneratorDomainService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        while (attempt < maxAttempts)
        {
            ...
            var exists = await _accountRepository.AnyAsync(
                new AccountByNumberSpecification(accountNumber), cancellationToken);
    ...
    private AccountNumber GenerateAccountNumber(string accountType)
    {
        ...
        var prefix = accountType.ToUpper() switch
        {
            "CHECKING" => "10",
            "SAVINGS" => "20",
            "INVESTMENT" => "30",
...
/// <summary>
/// Specification for finding account by number
/// </summary>
public class AccountByNumberSpecification : Specification<Account>
{
    public AccountByNumberSpecification(AccountNumber accountNumber)
    {
        Criteria = account => account.AccountNumber == accountNumber;
    }
}
